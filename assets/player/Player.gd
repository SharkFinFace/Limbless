...
# Hehe I made a change VVV I made it export ahaha
export var yaw_pitch : Vector2 = Vector2.ZERO
# I also changed VVV to export lol
export var target_yaw_pitch : Vector2 = Vector2.ZERO
...
func handle_input():
	...
	# I made it so the zoom can happen whenever.
